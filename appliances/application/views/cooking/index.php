	...
	<div class="container">
	    <nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Cooking Appliances</li>
		  </ol>
		</nav>
	</div>
</div>
<div class="maincatlist">
	<div class="container">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_mixer_grinderInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_mixer_grinderInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					<h3 class="title"><?php echo $subcat_mixer_grinderInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_mixer_grinderInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>cooking/category/<?php echo $subcat_mixer_grinderInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
					<figure><img src="<?php echo base_url(); ?>res/images/mixer-grinder-right.jpg" alt="Mixer Grinder"></figure>
				</div>
			</div>	
		</div>
		<hr/>
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					<h3 class="title"><?php echo $subcat_chopperInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_chopperInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>cooking/category/<?php echo $subcat_chopperInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_chopperInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_chopperInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
					<figure><img src="<?php echo base_url(); ?>res/images/chopper2.jpg" alt="Chopper"></figure>
				</div>
			</div>	
		</div>
		<hr/>
		<div class="row align-items-center">
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_hand_blenderInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_hand_blenderInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					<h3 class="title"><?php echo $subcat_hand_blenderInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_hand_blenderInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>cooking/category/<?php echo $subcat_hand_blenderInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					<h3 class="title"><?php echo $subcat_electric_kettleInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_electric_kettleInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>cooking/category/<?php echo $subcat_electric_kettleInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>	
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_electric_kettleInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_electric_kettleInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
		</div>	
		<hr/>
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_sandwich_makerInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_sandwich_makerInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					<h3 class="title"><?php echo $subcat_sandwich_makerInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_sandwich_makerInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>cooking/category/<?php echo $subcat_sandwich_makerInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
					<figure><img src="<?php echo base_url(); ?>res/images/sandwich-maker-right.jpg" alt="sandwich maker"></figure>
				</div>
			</div>	
		</div>
		<hr/>
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					<h3 class="title"><?php echo $subcat_rice_cookerInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_rice_cookerInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>cooking/category/<?php echo $subcat_rice_cookerInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_rice_cookerInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_rice_cookerInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
					<figure><img src="<?php echo base_url(); ?>res/images/cooking-rice-2.png" alt="Rice Cooker"></figure>
				</div>
			</div>	
		</div>
	</div>	
