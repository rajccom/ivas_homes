	...
	<div class="container">
	    <nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Fabric Care Appliances</li>
		  </ol>
		</nav>
	</div>
</div>
<div class="maincatlist">
	<div class="container">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_dry_ironInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_dry_ironInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					<h3 class="title"><?php echo $subcat_dry_ironInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_dry_ironInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>fabric/category/<?php echo $subcat_dry_ironInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
					<figure><img src="<?php echo base_url(); ?>res/images/dry-iron-right.jpg" alt="Dry Iron"></figure>
				</div>
			</div>	
		</div>
		<hr/>
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					<h3 class="title"><?php echo $subcat_steam_ironInfo->sub_cat_name; ?></h3>
					<p class="desc"><?php echo $subcat_steam_ironInfo->sub_cat_desc; ?></p>
					<p class="link"><a href="<?php echo base_url(); ?>fabric/category/<?php echo $subcat_steam_ironInfo->sub_cat_slug; ?>/">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
					<figure><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_steam_ironInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_steam_ironInfo->sub_cat_name; ?>"></figure>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
					<figure><img src="<?php echo base_url(); ?>res/images/steam-iron1.jpg" alt="Steam iron"></figure>
				</div>
			</div>	
		</div>	
	</div>	
