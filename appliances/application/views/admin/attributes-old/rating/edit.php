					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="card ">
							<div class="card-header border-0">
								<h4 class="card-title">Edit Star Rating</h4>
							 ...
							 <form class="add-dept" name="edit-rating" method="post" action="<?php //echo $action; ?>" >
								<div class="card-body" >
									<div class="row">
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<?php $status = $this->form_data->sr_status; ?>
								...
								<div class="col-md-12 card-footer">
									<div class="form-group float-end">
										<input type="submit"  name="editrating"  class="btn btn-primary" value="Save Changes">
									</div>
								</div>
							</form>
						</div>
