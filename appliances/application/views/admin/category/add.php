					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="card ">
							<div class="card-header border-0">
							 ...
							 <form class="add-dept" name="add-cate" method="post" action="<?php //echo $action; ?>" enctype="multipart/form-data">
								<div class="card-body" >
									<div class="row">
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="cat_desc" id="cat_desc" value="<?php echo set_value('cat_desc', $this->form_data->cat_desc); ?>"></textarea> <br/>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<div class="input-group file-browser">
													<input class="form-control" name="cat_back_img" type="file" required>
												</div>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<div class="input-group file-browser">
													<input class="form-control" name="cat_list_img" type="file" required>
												</div>
												<small class="text-muted"><i>The file size should not be more than 1MB</i></small>
