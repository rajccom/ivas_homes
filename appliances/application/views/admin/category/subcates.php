									...
									<table class="table table-vcenter text-nowrap table-bordered table-striped ticketdeleterow w-100" id="sts-table">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php if ($subcate->sub_cat_thumb_img) { ?><img src="<?php echo base_url(); ?>assets/sub-category-thumb-img/<?php echo $subcate->sub_cat_thumb_img; ?>" > <?php } ?></td>
