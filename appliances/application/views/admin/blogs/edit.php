					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="card ">
							<div class="card-header border-0">
							 ...
							 <form class="add-dept" name="edit-blog" method="post" action="<?php //echo $action; ?>" enctype="multipart/form-data">
								<div class="card-body" >
									<div class="row">
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="blog_short_content" id="blog_short_content" value="<?php echo set_value('blog_short_content', $this->form_data->blog_short_content); ?>"><?php echo set_value('blog_short_content', $this->form_data->blog_short_content); ?></textarea> <br/>
                          						<?php echo form_error('blog_short_content'); ?>
											</div>
										</div>
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												<label class="form-label">Update Blog Image</label>
												<img class="mb-3" src="<?php echo base_url(); ?>assets/blogs/<?php echo $this->form_data->blog_img; ?>" height="70px">
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="meta_desc" id="meta_desc"><?php echo set_value('meta_desc', $this->form_data->meta_desc); ?></textarea> <br/>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="meta_keyword" id="meta_keyword"><?php echo set_value('meta_keyword', $this->form_data->meta_keyword); ?></textarea> <br/>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<?php $status = $this->form_data->blog_status; ?>
								...
								<div class="col-md-12 card-footer">
									<div class="form-group float-end">
										<input type="submit"  name="editblog"  class="btn btn-primary" value="Save Changes">
									</div>
								</div>
							</form>
						</div>
