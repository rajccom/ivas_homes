...
class Fabric extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_dry_iron = 10;
		$subcat_steam_iron = 11;
		$subcat_dry_ironInfo = $this->admin_model->get_sub_category_byId($subcat_dry_iron)->row();
		$data['subcat_dry_ironInfo'] = $subcat_dry_ironInfo;
		$subcat_steam_ironInfo = $this->admin_model->get_sub_category_byId($subcat_steam_iron)->row();
		$data['subcat_steam_ironInfo'] = $subcat_steam_ironInfo;
	...
	public function category($slug)
	{
		...
		$catID = 3; 
		$fabriccatslug = "fabric";
		$data['fabriccatslug'] = $fabriccatslug;
		...
		$this->load->view('fabric/category', $data);
	}
