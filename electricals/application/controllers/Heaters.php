...
class Heaters extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_instantheater = 10;
		$subcat_storageheater = 11;
		$subcat_immersionheater = 12;
		$subcat_instantheaterInfo = $this->admin_model->get_sub_category_byId($subcat_instantheater)->row();
		$data['subcat_instantheaterInfo'] = $subcat_instantheaterInfo;
		$subcat_storageheaterInfo = $this->admin_model->get_sub_category_byId($subcat_storageheater)->row();
		$data['subcat_storageheaterInfo'] = $subcat_storageheaterInfo;
		$subcat_immersionheaterInfo = $this->admin_model->get_sub_category_byId($subcat_immersionheater)->row();
		$data['subcat_immersionheaterInfo'] = $subcat_immersionheaterInfo;
		...
		$this->load->view('heaters/index', $data);
	}
	public function category($slug)
	{
		...
		$catID = 3; 
		$heatercatslug = "heaters";
		$data['heatercatslug'] = $heatercatslug;
		...
		$this->load->view('heaters/category', $data);
	}
