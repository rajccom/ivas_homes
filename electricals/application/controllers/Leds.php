...
class Leds extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_cellingled = 7;
		$subcat_outdoorled = 8;
		$subcat_industrialled = 9;

		$subcat_ledbulbInfo = $this->admin_model->get_sub_category_byId($subcat_ledbulb)->row();
		$data['subcat_ledbulbInfo'] = $subcat_ledbulbInfo;
		$subcat_cellingledInfo = $this->admin_model->get_sub_category_byId($subcat_cellingled)->row();
		$data['subcat_cellingledInfo'] = $subcat_cellingledInfo;
		$subcat_outdoorledInfo = $this->admin_model->get_sub_category_byId($subcat_outdoorled)->row();
		$data['subcat_outdoorledInfo'] = $subcat_outdoorledInfo;
		$subcat_industrialledInfo = $this->admin_model->get_sub_category_byId($subcat_industrialled)->row();
		$data['subcat_industrialledInfo'] = $subcat_industrialledInfo;
		...
		$this->load->view('leds/index', $data);
	}	
	public function category($slug)
	{
		...
		$attributeLists = $this->admin_model->get_attribute_bycat($catID)->result();
		$data['attributeLists'] = $attributeLists;

		$attributevalueLists = $this->admin_model->get_attributes_values_bycat($catID)->result();
		...
		$this->load->view('leds/category', $data);
	}
