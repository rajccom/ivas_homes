					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="card ">
							<div class="card-header border-0">
								<h4 class="card-title">Create Body</h4>
							 ...
							 <form class="add-dept" name="add-body" method="post" action="<?php //echo $action; ?>">
								<div class="card-body" >
									<div class="row">
								...
								<div class="col-md-12 card-footer">
									<div class="form-group float-end">
										<input type="submit"  name="addbody"  class="btn btn-primary" value="Add Body">
									</div>
								</div>
							</form>
						</div>
