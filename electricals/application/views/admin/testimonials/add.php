					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="card ">
							<div class="card-header border-0">
							 ...
							 <form class="add-dept" name="add-testi" method="post" action="<?php //echo $action; ?>" enctype="multipart/form-data">
								<div class="card-body" >
									<div class="row">
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												<label class="form-label">Testimonial <span class="text-red">*</span></label>
												<textarea class="form-control" name="testimonial" id="testimonial" value="<?php echo set_value('testimonial', $this->form_data->testimonial); ?>"></textarea> <br/>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												<label class="form-label">Upload Client Image</label>
								...
								<div class="col-md-12 card-footer">
									<div class="form-group float-end">
										<input type="submit"  name="addtesti"  class="btn btn-primary" value="Add Testimonial">
									</div>
								</div>
							</form>
						</div>
