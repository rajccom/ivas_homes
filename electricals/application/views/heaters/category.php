	...
	<div class="container">
	    <nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>heaters/">Heaters</a></li>
					...
					<div class="catfiltblk">
						...
						<div class="collapse show" id="filtertypes">
						  <div class="card card-body">
							...
							?>	
							<div class="form-check">
							  <a href="<?php echo base_url(); ?><?php echo $heatercatslug; ?>/category/<?php echo $subcate->sub_cat_slug; ?>/"><input class="form-check-input" type="checkbox" value="<?php echo $subcate->sub_cat_id; ?>" name="<?php echo $subcate->sub_cat_slug; ?>" id="type-<?php echo $subcate->sub_cat_slug; ?>" <?php if($subcate->sub_cat_id == $subcateInfo->sub_cat_id){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $heatercatslug; ?>/category/<?php echo $subcate->sub_cat_slug; ?>")'>
...
<script>
    jQuery(document).ready(function() {
        ...
        jQuery.ajax({
             url : "<?php echo base_url('heaters/filterproducts') ?>",
             type: "post",
