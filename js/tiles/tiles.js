...
$(document).on('click', '#LoadMore', function() {
  ...
  var lastId = $('.loader').attr('id');
    ...
    function filter_data(lastId)
    {
        ...
        var applications = get_filter('applications');
        // var application_one = get_filter('application_one');
        // var application_two = get_filter('application_two');
        var applications_areas = get_filter('applications_areas');
        ...
        $.ajax({
            ...
            method:"POST",
            data:{action:action, category:category, last_id:lastId, colour:colour, finishs:finishs, style:style, size:size, applications:applications, applications_areas:applications_areas},
            beforeSend:function(){
