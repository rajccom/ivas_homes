...
$(document).on('click', '#LoadMore', function() {
  ...
  var lastId = $('.loader').attr('id');
    ...
    function filter_data(lastId)
    {
        ...
        var colours = get_filter('colours');
        ...
        // var colour_seven = get_filter('colour_seven');
        // var colour_eight = get_filter('colour_eight');
        // var colour_nine = get_filter('colour_nine');
        // var colour_ten = get_filter('colour_ten');
        // var colour_eleven = get_filter('colour_eleven');
        // var colour_twelve = get_filter('colour_twelve');
        // var colour_thirteen = get_filter('colour_thirteen');
        ...
        $.ajax({
            url:"./bath-fittings/bath-fitting_data.php",
            method:"POST",
            data:{action:action, category:category, last_id:lastId, colours:colours, type:type, cock_type:cock_type, finish:finish, finish_one:finish_one, finish_two:finish_two, finish_three:finish_three, finish_four:finish_four, finish_five:finish_five, collection:collection},
            beforeSend:function(){
