...
<link rel="canonical" href="https://www.ivas.homes/thank-you" />
...
<section class="contact-us inquiry-model my-5">
    <div class="container">
        ...
        <div class="row text-center form-policy">
            <div class="col-sm-12">
		...
		<p class="text-center"><a class="btn btn-lg btn-dark rounded-circle" href="https://www.ivas.homes/">Back to home</a></p>
            </div>
        </div>
    </div>
</section>
...
setTimeout(function()
{ 
window.location = "https://www.ivas.homes/"; 
},10000);
</script>
