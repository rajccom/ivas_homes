<div class="container my-5">
  <h2>Experience IVAS Modular Kitchen Store Near You</h2>
  <form>
...
$result = mysqli_query($conn, "SELECT * FROM modular_kitchen_state ORDER BY state_name ASC");
  ...
  $(document).ready(function() {
    $('#state-dropdown').on('change', function() {
      ...
      if(states_id === '') {
        ...
        $.ajax({
          url: "./modular-kitchen/cities-by-state.php",
          type: "POST",
          data: {
            states_id: states_id
          },
    ...
    $('#city-dropdown').on('change', function() {
      ...
      if(cities_id === '') {
        ...
        $.ajax({
          url: "./modular-kitchen/address-by-city.php",
          type: "POST",
          data: {
            cities_id: cities_id
          },
