    ...
    function lead_api($request_body, $api_url, $max_retries = 3, $retry_interval = 5) {
        ...
        do {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_POSTFIELDS => $request_body, // Send the request body directly
...
$request_body = array(
    ...
    if ($api_response['http_status_code'] !== 200) {
        ...
        // Build the SQL query
        $sql = "INSERT INTO contact_lead (category, sname, phone, email, city, msg) VALUES ('$category', '$name', '$phone', '$emails', '$city', '$msg')";
        // Execute the query
