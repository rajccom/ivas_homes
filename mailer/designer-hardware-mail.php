...
if (isset($_POST['submit'])) {
        $conn = mysqli_connect("localhost", "ivas_homes", "a4qhe6aaw6of", "ivas_homes");         $sname = strip_tags(addslashes($_POST['sname']));
        ...
        mysqli_query($conn, "INSERT INTO designer_hardware_leads (sname, phone, email, city, utm_source, utm_medium, utm_campaign, utm_term, utm_content) 
